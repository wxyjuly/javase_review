...
class MyThread extends Thread {
    ...
    @Override
    public void run() {
        synchronized(this) { //继承Thread，new线程，synchronized(this)会出现两个锁。
            try {  
                for (int i = 0; i < 5; i++) {
...
public class SynchronizedThreadRuleDemo01 {

    public static void main(String[] args) {  
        Thread t1 = new MyThread("thread-1");  // 新建“线程thread-1”
        Thread t2 = new MyThread("thread-2");  // 新建“线程t2”
