...
class MyThread1 extends Thread {
    ...
    @Override
    public void run() {
        synchronized(MyThread2.class) { //MyThread1.class还是锁不住
            try {  
                for (int i = 0; i < 5; i++) {
...
public class SynchronizedThreadClassLockRuleDemo1 {

    public static void main(String[] args) {  
        Thread t1 = new MyThread2("thread-1");  // 新建“线程thread-1”
        Thread t2 = new MyThread2("thread-2");  // 新建“线程t2”
