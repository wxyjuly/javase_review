package org.leanxi.utils.jedis;
...
public class JedisTest {
	...
	public static final String SINGLE_JEDIS_IP = "127.0.0.1" ;
	
	@Test
	public void testJedisSingle() {
		//创建一个jedis的对象。
		Jedis jedis = new Jedis(SINGLE_JEDIS_IP, 6379);
	...
	public void testJedisPool() {
		//创建jedis连接池
		JedisPool pool = new JedisPool(SINGLE_JEDIS_IP, 6379);
		//从连接池中获得Jedis对象
	...
	public void testJedisCluster() {
		...
		nodes.add(new HostAndPort(SINGLE_JEDIS_IP, 7004));
		nodes.add(new HostAndPort(SINGLE_JEDIS_IP, 7005));
		nodes.add(new HostAndPort(SINGLE_JEDIS_IP, 7006));
